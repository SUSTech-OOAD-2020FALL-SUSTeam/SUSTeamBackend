...
import susteam.achievement.Achievement
import susteam.achievement.AchievementRepository
import susteam.achievement.UserAchievementProcess
import susteam.achievement.toAchievement
...
class AchievementRepositoryImpl @Inject constructor(private val database: JDBCClient) : AchievementRepository {
    ...
    override suspend fun getUserAchievementProcess(username: String, achievementId: Int): UserAchievementProcess? {
        return database.querySingleWithParamsAwait(
            """SELECT username, achievement_id, rate_of_process, finished FROM user_achievement_progress WHERE username = ? and achievement_id = ?;""",
